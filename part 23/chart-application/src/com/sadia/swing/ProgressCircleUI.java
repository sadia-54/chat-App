...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/com/sadia/icon/down.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/com/sadia/icon/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/com/sadia/icon/file.png")).getImage();
    }

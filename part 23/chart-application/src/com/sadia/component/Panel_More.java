...
import com.sadia.emoji.Emogi;
import com.sadia.emoji.Model_Emoji;
import com.sadia.event.PublicEvent;
import com.sadia.main.Main;
...
import com.sadia.swing.WrapLayout;
...
public class Panel_More extends javax.swing.JPanel {
    ...
    private JButton getButtonImage() {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/sadia/icon/image.png")));
    ...
    private JButton getButtonFile() {
        OptionButton cmd = new OptionButton();
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/sadia/icon/link.png")));
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JFileChooser ch = new JFileChooser();

...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/sadia/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/sadia/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.sadia.swing.JIMSendTextPane();
    ...
    private com.sadia.swing.JIMSendTextPane txt;
